...
//encoded in a simple format...sounds like Base64...

//need to turn it into a Data type
let encodedData = prompt.data(using: .utf8)!

//bind and print the final string using an initializer
